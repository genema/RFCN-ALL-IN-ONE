...
def vis_detections(im, class_name, dets, image_name, thresh=0.5):
    ...
    for i in inds:
        ...
        print '>> detected %s (%d, %d, %d, %d)' % (class_name, bbox[0], bbox[1], bbox[2]-bbox[0], bbox[3]-bbox[1])
    '''
...
if __name__ == '__main__':
    if not os.path.isdir('/home/ghma/py-R-FCN/results'):
        os.mkdir('/home/ghma/py-R-FCN/results')
